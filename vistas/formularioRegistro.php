    ...
    <div class="container" style="max-width: 600px;">
        <div class="card shadow">
            <div class="card-body p-4">
                <h1 class="card-title text-center text-primary mb-2"><i class="bi bi-pencil-square"></i> Inscripción</h1>
                ...
                <form action="index.php?c=Registro&m=procesarRegistro" method="POST">
                    <div class="mb-3">
                        <label for="nombreUsuario" class="form-label">Nombre usuario: <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="nombreUsuario" name="nombreUsuario" required>
                        <div class="form-text">(no se puede repetir)</div>
                    </div>
                    
                    <div class="mb-3">
                        <label for="apeNombre" class="form-label">Apellidos y Nombre: <span class="text-danger">*</span></label>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="tel" class="form-control" id="telefono" name="telefono" pattern="[0-9]{9}" maxlength="9">
                    ...
                    <div class="card bg-light mb-3">
                        <div class="card-body">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="deporte<?= $deporte['idDeporte'] ?>" 
                                       name="deportes[]" value="<?= $deporte['idDeporte'] ?>">
                    ...
                    <div class="card bg-warning bg-opacity-25 border-warning mb-3">
                        <div class="card-body">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="condiciones" name="condiciones" value="1" required>
